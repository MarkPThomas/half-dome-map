...
var prepareLayers = function () {
 //-------Blank icon to hide icons-------
  var myIconBlank = L.icon({  
    iconUrl: '../public/images/blank' + '.png',
    iconSize: [1,1],
    iconAnchor: [1,1],
  });
  ...
  var belayCoords = [];
    ...
    var myIconBelaySmall = [];  //For zoom = 14
      ...
      myIconBelaySmall[i] = L.icon({
        iconUrl: '../public/images/marker-icon-belay0' + '.png',
        iconSize: [8,8],
        iconAnchor: [4,4],
  ...
  //--------Labels Icons---------- 
    ...
    var myIconTourists = L.icon({  
        iconUrl: '../public/images/StandardFamily' + '.png',
        iconSize: [scaledIconSize[0],scaledIconSize[1]],
        iconAnchor: [scaledAnchorSize[0],scaledAnchorSize[1]],
  ...
  var photoCoords = []; 
    ...
    //Icon formation types for photos
      ...
      var myPhotoIconHover = L.icon({
          iconAnchor: [6, 6],
          iconSize: [12, 12],
          iconUrl: '../public/images/marker-icon-photo-hover.png'
          });
    
      var myPhotoIconClick = L.icon({
          iconAnchor: [6, 6],
          iconSize: [12, 12],
          iconUrl: '../public/images/marker-icon-photo-clicked.png'
          });
    //================================
...
// === DNWF Start
  ...
  var myIconHonnold= L.icon({  
    iconUrl: '../public/images/Alex-Honnold-small.png',
    iconSize: [scaledIconSize[0],scaledIconSize[1]],
    iconAnchor: [scaledAnchorSize[0],scaledAnchorSize[1]],
  });
  ...
  var myIconKong= L.icon({  
    iconUrl: '../public/images/Donkey-Kong-climb.gif',
    iconSize: [scaledIconSize[0],scaledIconSize[1]],
    iconAnchor: [scaledAnchorSize[0],scaledAnchorSize[1]],
  });
  ...
  var myIconKongBarrel = L.icon({  
    iconUrl: '../public/images/Donkey-Kong-Barrel.gif',
    iconSize: [scaledIconSize[0],scaledIconSize[1]],
    iconAnchor: [scaledAnchorSize[0],scaledAnchorSize[1]],
  });
 ...
 var barrelLineR2 = _polyline([
  ...
  var myIconBarrel = L.icon({  
    iconUrl: '../public/images/Barrel.png',
    iconSize: [scaledIconSize[0],scaledIconSize[1]],
    iconAnchor: [scaledAnchorSize[0],scaledAnchorSize[1]],
  });
